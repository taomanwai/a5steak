...
public class MobileVisionCamView extends RelativeLayout {
    ...
    public MobileVisionCamView(Context context) {
        super(context);
        init(context);
    }

    public MobileVisionCamView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MobileVisionCamView(Context context, AttributeSet attrs, int defStyleAttr) {
