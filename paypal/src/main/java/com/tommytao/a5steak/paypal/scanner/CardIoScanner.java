package com.tommytao.a5steak.paypal.scanner;
 ...
 */
public class CardIoScanner extends Foundation {

    private static CardIoScanner instance;

    public static CardIoScanner getInstance() {

        if (instance == null)
            instance = new CardIoScanner();

        return instance;
    }

    private CardIoScanner() {
    ...
    public static class CardIoActivity extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            listener = (id == -1) ? null : CardIoScanner.getInstance().scanListeners.get(id);
            CardIoScanner.getInstance().scanListeners.remove(id);
