package com.tommytao.a5steak.time.ext.net.ntp;
/*
...
import com.tommytao.a5steak.time.ext.net.DatagramSocketClient;
...
public final class NTPUDPClient extends DatagramSocketClient {
     ...
     * @throws java.io.IOException If an error occurs while retrieving the time.
     *                             *
     */
